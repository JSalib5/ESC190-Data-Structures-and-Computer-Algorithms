 ...
 * Side-effects:  none
 */
size_t avlbag_size(const bag_t *b);
 ...
 */
size_t avlbag_elems(const bag_t *b, bag_elem_t *a);
 ...
 */
void avlbag_traverse(const bag_t *b, void (*f)(bag_elem_t));
 ...
 * Side-effects:  none
 */
bool avlbag_contains(const bag_t *b, bag_elem_t e);
 ...
 */
bool avlbag_insert(bag_t *b, bag_elem_t e);
 ...
 */
bool avlbag_remove(bag_t *b, bag_elem_t e);
